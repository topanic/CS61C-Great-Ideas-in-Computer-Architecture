...
{
    //YOUR CODE HERE
	ComplexNumber* cnum = (ComplexNumber*) malloc(sizeof(ComplexNumber));
	cnum->real = real_component;
	cnum->imaginary = imaginary_component;
	return cnum;
}
...
{
    //YOUR CODE HERE
	ComplexNumber* ncn = newComplexNumber(0.0, 0.0);
	ncn->real = a->real * b->real - a->imaginary * b->imaginary;
	ncn->imaginary = a->real * b->imaginary + b->real * a->imaginary;
	return ncn;
}
...
ComplexNumber* ComplexSum(ComplexNumber* a, ComplexNumber* b)
{
    //YOUR CODE HERE
	ComplexNumber* ncn = newComplexNumber(0.0, 0.0);
	ncn->real = a->real + b->real;
	ncn->imaginary = a->imaginary + b->imaginary;
	return ncn;
}
